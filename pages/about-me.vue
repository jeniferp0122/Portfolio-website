  ...
  <main v-if="!loading" id="about-me" class="page">
    ...
    <div id="page-menu" class="w-full flex">
      ...
      <div id="section-content" class="hidden lg:block w-full h-full border-right">
        ...
        <div>
          <div
            v-for="(folder, key, index) in config.dev.about.sections[currentSection].info"
            :key="key"
        ...
        <div
          id="contact-sources"
          class="hidden lg:flex lg:flex-col my-2"
        >
          <div
      ...
      <div id="section-content" class="lg:hidden w-full font-fira_regular">
        <div v-for="section in config.dev.about.sections" :key="section.title">
          ...
          <div :id="'folders-' + section.title" class="hidden">
            <div
              v-for="(folder, key, index) in config.dev.about.sections[section.title].info"
              :key="key"
...
<div class="flex flex-col lg:grid lg:grid-cols-2 h-full w-full">
  ...
  <div id="left" class="w-full flex flex-col border-right">
    ...
    <div id="tab-mobile" class="flex lg:hidden font-fira_retina">
      ...
      <h3
        v-html="config.dev.about.sections[currentSection].info[folder].title"
  ...
  <!-- Right Column -->
  <div id="right" class="w-full flex flex-col">
    <!-- windows tab -->
    ...
    <!-- Terminal Component -->
    <div id="gists-content" class="flex flex-grow">
      <div id="gists" class="flex-grow w-full">
        <Terminal />
      </div>
      <!-- scroll bar -->
      <div id="scroll-bar" class="h-full border-left hidden lg:flex justify-center py-1">
...
export default {
  ...
  methods: {
    ...
    focusCurrentFolder(folder) {
      ...
      this.currentSection = this.config.dev.about.sections[this.currentSection].info[folder.title]
        ? this.currentSection
        : Object.keys(this.config.dev.about.sections).find(
            (section) => this.config.dev.about.sections[section].info[folder.title]
          );
    },
    toggleFiles() {
...
#gists-content {
  height: 100%;
  overflow: hidden; /* Removed fixed width */
}
